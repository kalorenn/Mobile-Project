...
public class QueryTester {
    public static final Listing BMW_X5 = new Listing(new Car("bmw", "x5", 2000, true), 10000, 200, 1);
    public static final Listing BMW_E60 = new Listing(new Car("bmw", "e60", 2005, false), 7000, 300, 1);
    public static final Listing A4_OLD = new Listing(new Car("audi", "a4", 2001, false), 5000, 400, 1);
    public static final Listing A4_NEW = new Listing(new Car("audi", "a4", 2003, false), 5000, 500, 1);
